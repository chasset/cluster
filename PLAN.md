...
consommation de disques maîtrisée, et une documentation honnête (plus de checks
« Not implemented » trompeurs ; SPOF, endpoint control-plane, NVMe block.db et
sauvegarde etcd explicités).
