  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        ...
        collapsed: true,
        items: [
          { text: 'Synthèse & tableau de bord', link: '/docs/audit/' },
          { text: '1 — Bonnes pratiques IaC', link: '/docs/audit/01-bonnes-pratiques' },
          { text: '2 — Tests multi-niveaux', link: '/docs/audit/02-tests' },
          { text: '3 — Lint & chaîne qualité', link: '/docs/audit/03-lint-format' },
          { text: '4 — Documentation', link: '/docs/audit/04-documentation' },
          { text: '5 — Reproductibilité', link: '/docs/audit/05-reproductibilite' },
          { text: '6 — Sécurité', link: '/docs/audit/06-securite' },
          { text: '7 — Gouvernance', link: '/docs/audit/07-gouvernance' },
          { text: '8 — Opérabilité & résilience', link: '/docs/audit/08-operabilite' },
          { text: '9 — Langage des scripts', link: '/docs/audit/09-langage-scripts' },
