...
2. Pour chaque critère ci-dessous : recopier la réponse (Met / N/A) et coller la
   justification + l'URL de preuve. Base des URL :
   `https://github.com/univ-lehavre/cluster/blob/main/`.
...
| `contribution_requirements` | Met       | `CONTRIBUTING.md` : sujet minuscule, ≤100 col, lint pre-push, traçabilité ADR/plan/issue/PR.                                                   |
