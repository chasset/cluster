...
| kube-vip        | **1.2.0**                  | [`bootstrap/roles/kube-vip/defaults/main.yaml`](../../bootstrap/roles/kube-vip/defaults/main.yaml) (`kube_vip_digest`, index multi-arch — VIP HA `ha-3cp`, ADR 0047/0055) |
...
> De même, `.terraform.lock.hcl` figera OpenTofu + providers à l'introduction du
> code de provisioning ([ADR 0032](0032-opentofu-provisioning-cloud.md)).
