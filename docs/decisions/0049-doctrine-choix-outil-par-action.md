...
| **Comportement des fonctions bash pures**                                                                                                   | **bats** (`bench/unit/`, libs `bootstrap/lib/`)                               | shellcheck valide la syntaxe, bats le comportement. Un code de logique sans test n'est pas mergeable.                                                                                                                                                                |
