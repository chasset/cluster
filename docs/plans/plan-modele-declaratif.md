...
| ------ | ---------- | -------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P0     | ✅ fait    | —                                | `topologies/socle.example.yaml` + paquet `nestor/`                                                                                                                                                                                       |
| P1     | ✅ fait    | —                                | **inventaires prod + banc byte-identiques** (12 tests, vs `hosts.example.yaml` et `write_inventory`)                                                                                                                                     |
| P2     | ✅ fait    | —                                | **dérivation de profil** (inclusion cumulative ADR 0039 + faisceau `-e` à parité bash, `nestor/profile.py`, 12 tests)                                                                                                                    |
...
| P4     | ✅ fait    | —                                | **épreuves filtrées + historique lu** (`nestor/epreuves.py` miroir de la matrice + `history.py` à parité fraîcheur bash ; commandes `epreuves`/`runs` ; 40 tests)                                                                        |
