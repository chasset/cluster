...
| **Reproductibilité prouvée**   | Le cluster se monte **de zéro**, sans intervention manuelle, en un temps mesuré et consigné.         | [journal des runs Lima](../bench/lima/RESULTS.md) · [ce que le banc prouve](architecture/validation-banc.md)                                         |
...
| **Couverture E2E**             | Des épreuves réelles (unitaires, intégration de chaîne, chaos) exercent chaque chaîne fonctionnelle. | [scénarios reproductibles](../bench/scenarios/) · [matrice du catalogue](architecture/matrice-catalogue.md)                                          |
