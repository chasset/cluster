...
([ADR 0022](/cluster/docs/decisions/0022-argocd-gitops-applicatif/)). Argo CD ne
...
([`bootstrap/roles/platform-gitea/`](https://github.com/univ-lehavre/cluster/blob/main/bootstrap/roles/platform-gitea)),
...
([`bench/lima/`](/cluster/bench/lima/)) — hors de cette brique.

## Manifestes

| Fichier                                                                                                                         | Rôle                                                                               |
| ------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| [`namespace.yaml`](https://github.com/univ-lehavre/cluster/blob/main/platform/gitea/namespace.yaml)                             | Namespace `gitea` (Pod Security `baseline`).                                       |
| [`persistent-volume-claim.yaml`](https://github.com/univ-lehavre/cluster/blob/main/platform/gitea/persistent-volume-claim.yaml) | PVC données (dépôts + SQLite). storageClass templé par le rôle.                    |
| [`deployment.yaml`](https://github.com/univ-lehavre/cluster/blob/main/platform/gitea/deployment.yaml)                           | Pod Gitea **rootless** (uid 1000), durci, image par digest.                        |
| [`service.yaml`](https://github.com/univ-lehavre/cluster/blob/main/platform/gitea/service.yaml)                                 | Service ClusterIP `gitea-http` :80 → 3000.                                         |
| [`gateway.yaml`](https://github.com/univ-lehavre/cluster/blob/main/platform/gitea/gateway.yaml)                                 | Exposition UI (Gateway Cilium + HTTPRoute, TLS cert-manager) — portail atlas #232. |

NetworkPolicies sous default-deny
([`00-default-deny.yaml`](https://github.com/univ-lehavre/cluster/blob/main/platform/network-policies/gitea/00-default-deny.yaml) +
[`allow-dns.yaml`](https://github.com/univ-lehavre/cluster/blob/main/platform/network-policies/gitea/allow-dns.yaml) +
[`allow-gitea.yaml`](https://github.com/univ-lehavre/cluster/blob/main/platform/network-policies/gitea/allow-gitea.yaml))
: ingress `:3000` + egress webhook → `argocd-server`, **pas d'Internet**.
