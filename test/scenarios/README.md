...
| 27  | GitOps → DataOps (push e2e)  | **Push** sur Gitea → **webhook** → Argo CD **Synced/Healthy** → run Dagster + **lineage Marquez** | ~5 min        | **Intégration** chaîne complète atlas (ADR 0044/0045, #231) — _à implémenter_ |
